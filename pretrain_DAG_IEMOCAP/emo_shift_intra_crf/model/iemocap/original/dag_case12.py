...
def analyze_case1_2(emo_dict, outputs, dialog, emo2num, case1_dict, case2_dict):
    ...
    print("case 1 WEIGHTED F1:", round(f1_score(labels, predicts, average='weighted')*100, 2), '%')
    ...
    print("case 2 WEIGHTED F1:", round(f1_score(labels, predicts, average='weighted')*100, 2), '%')
    
if __name__ == '__main__':
    total_closest = 0
    closest_self_opp_cnt = 0
    dialog = joblib.load('../../../../data/iemocap/four_type/dialog_rearrange.pkl')
    dialog_edit = joblib.load('../../../../data/iemocap/four_type/dialog_rearrange_4emo_iemocap.pkl')
