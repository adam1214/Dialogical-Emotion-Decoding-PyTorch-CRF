...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim):
        ...
        self.transitions = nn.Parameter(torch.randn(self.tagset_size, self.tagset_size)) #5*5
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        print('Check predictions before training')
    ...
    with torch.no_grad():
        precheck_sent = prepare_sequence(training_data[0][0], word_to_ix)
        print('Check predictions after training')
        print(model(precheck_sent))
    # We got it!