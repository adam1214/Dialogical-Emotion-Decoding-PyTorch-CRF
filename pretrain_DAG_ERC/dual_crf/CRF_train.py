...
if __name__ == "__main__":
    ...
    if args.dataset == 'iemocap_original' or args.dataset == 'iemocap_U2U':
        optimizer = optim.SGD(model.parameters(), lr=0.01, weight_decay=0.01, momentum=0.8)
    elif args.dataset == 'meld':
        #f1:0.6370
        optimizer = optim.SGD(model.parameters(), lr=0.008, weight_decay=0.05, momentum=0.9)
