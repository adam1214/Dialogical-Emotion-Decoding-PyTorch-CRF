...
if __name__ == "__main__":
    ...
    if args.dataset == 'iemocap_original_6' or args.dataset == 'iemocap_U2U':
    ...
    for i in range(0, len(label), 1):
        if args.dataset == 'iemocap_original_4' or args.dataset == 'iemocap_U2U':
            if label[i] not in ['ang', 'hap', 'neu', 'sad']:
                label[i] = -1
            else:
