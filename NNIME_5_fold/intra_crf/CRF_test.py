...
def view_new_matrix(model, fold_num):
    with torch.no_grad():
        ...
        np.save('intra_trans_fold' + str(fold_num) + '.npy', np.array(model.transitions)[:4,:4])
...
if __name__ == "__main__":
    ...
    #out_dict = joblib.load('../data/original_output/audio/DAG_outputs_4_all_fold_interspeech_audio.pkl')
